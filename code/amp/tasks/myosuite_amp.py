...
from .amp.myosuite_amp_base import MyoSuiteAMPBase, dof_to_obs
...
# modified for Atlas
NUM_AMP_OBS_PER_STEP = 71 # [root_h, root_rot, root_vel, root_ang_vel, dof_pos, dof_vel, key_body_pos]

class MyoSuiteAMP(MyoSuiteAMPBase):
    ...
    def __init__(self, cfg, sim_device, graphics_device_id, headless):
        ...
        self._state_init = MyoSuiteAMP.StateInit[state_init]
    ...
    def _reset_actors(self, env_ids):
        if (self._state_init == MyoSuiteAMP.StateInit.Default):
            self._reset_default(env_ids)
        elif (self._state_init == MyoSuiteAMP.StateInit.Start
              or self._state_init == MyoSuiteAMP.StateInit.Random):
            self._reset_ref_state_init(env_ids)
        elif (self._state_init == MyoSuiteAMP.StateInit.Hybrid):
    ...
    def _reset_ref_state_init(self, env_ids):
        ...
        if (self._state_init == MyoSuiteAMP.StateInit.Random
            or self._state_init == MyoSuiteAMP.StateInit.Hybrid):
    ...
    def _reset_soccer_ball(self, env_ids):
        ...
        self.gym.set_actor_root_state_tensor_indexed(self.sim, gymtorch.unwrap_tensor(self._root_states),
                                                gymtorch.unwrap_tensor(env_soccer_ball_ids_int32), len(env_soccer_ball_ids_int32))

        return env_soccer_ball_ids_int32
