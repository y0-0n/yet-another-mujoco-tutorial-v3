...
class SMPLRigAMPBase(VecTask):
    ...
    def _create_ray_envs(self):
        self.standard_env = MuJoCoParserClass(name='SMPL Rig',rel_xml_path=self.asset_file, VERBOSE=False,USE_MUJOCO_VIEWER=False)
        ...
        self.torso_index = self.standard_env.model.body('root').id # NOTE: Different from Isaac index
