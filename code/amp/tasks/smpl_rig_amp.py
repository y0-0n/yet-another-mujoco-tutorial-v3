...
from .amp.smpl_rig_amp_base import SMPLRigAMPBase, dof_to_obs
...
NUM_DEEPMIMIC_OBS = 99 # [root_p+root_rot+dof_pos(77), root_vel+root_ang_vel+dof_vel(43), key_body_pos(12), COM(3)]
...
class SMPLRigAMP(SMPLRigAMPBase):
    ...
    def __init__(self, cfg, sim_device, graphics_device_id, headless):
        ...
        self._state_init = SMPLRigAMP.StateInit[state_init]
