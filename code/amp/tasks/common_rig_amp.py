...
from .amp.common_rig_amp_base import CommonRigAMPBase, dof_to_obs
...
class CommonRigAMP(CommonRigAMPBase):
    ...
    def __init__(self, cfg, sim_device, graphics_device_id, headless):
        ...
        self._state_init = CommonRigAMP.StateInit[state_init]
    ...
    def _reset_actors(self, env_ids):
        if (self._state_init == CommonRigAMP.StateInit.Default):
            self._reset_default(env_ids)
        elif (self._state_init == CommonRigAMP.StateInit.Start
              or self._state_init == CommonRigAMP.StateInit.Random):
            self._reset_ref_state_init(env_ids)
        elif (self._state_init == CommonRigAMP.StateInit.Hybrid):
